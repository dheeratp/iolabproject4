...
function initialize() {
  ...
  $.when(getDataDone).then(function(){
      ...
      // Note: We scale the population by a factor of 20.
        var metrocolor,trackindex,toptrackname,toptrackartist,toptrackurl;
          for (var city in citymap) {
            ...
            for (var iterate=0;iterate<ALLTOPTRACKS.length;iterate++)
            {
                if(ALLTOPTRACKS[iterate]["city"]==city)
                {
                  ...
                  console.log("COLOR for metro"+city+" is "+metrocolor+" trackartist is "+toptrackartist);
                  break;
                }
        ...
        if(index==237)
        {
          console.log("reached 237");
           ...
           TOPTRACKS.push(objtoptracks);
            ...
            //obj["toptrackartistimg"]=x[2]["#text"];
            //console.log(x[2]["#text"]);
